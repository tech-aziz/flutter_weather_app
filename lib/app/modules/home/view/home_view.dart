...
class _HomeViewState extends State<HomeView> {
  ...
  List weatherTimeList = [
    customWeatherContainer(
        time: 'Now', img: 'assets/icons/cloudy.png', celsius: '13'),
    customWeatherContainer(
        time: '4PM', img: 'assets/icons/sun.png', celsius: '14'),
    customWeatherContainer(
        time: '5PM', img: 'assets/icons/partly_cloudy.png', celsius: '12'),
    customWeatherContainer(
        time: '6PM', img: 'assets/icons/rainy.png', celsius: '8'),
    customWeatherContainer(
        time: '7PM', img: 'assets/icons/partly_cloudy.png', celsius: '9'),
    customWeatherContainer(
        time: '8PM', img: 'assets/icons/cloudy.png', celsius: '2'),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: FutureBuilder<ForecastWeatherModel>(
                                    ...
                                    RichText(
                                      text: TextSpan(
                                        children: [
                                          TextSpan(
                                              text:
                                                  '${controller.forecastWeatherModel.value.current!.feelsLikeC}',
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Padding(
                                  ...
                                  child: customWeatherContainer(
                                    celsius: data.tempC.toString(),
                                    img: 'https://$demo',
                                    time: controller
                                        .convertToTime(data.time.toString()),
                                  ),
                                );
                              },
                            ),
